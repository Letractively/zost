      ...
      begin
        ...
        if HDDcount > 0 then
          if aDriveIndex < HDDcount then
            ...
            raise Exception.Create('Foi informado um identificador de drive fora dod limited. Existe(m) ' + IntToStr(HDDcount) + '. Identificadores válidos variam de 0 a ' + IntToStr(Pred(HDDcount)));
      end;
    finally
